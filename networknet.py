...
class Network(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.layers = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(),
            # input = 32 x 96 x 96, output = 32 x 48 x 48 
            ...
            #input = 128 x 12 x 12, output = 256 x 12 x 12
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, padding=1),
            nn.BatchNorm2d(256),
            nn.ReLU(),
            #input = 256 x 12 x 12, output = 256 x 6 x 6 
            nn.MaxPool2d(kernel_size=2, stride=2),
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Flatten(),
            nn.Linear(in_features = 3*3*512, out_features = 128),
            nn.ReLU(),
