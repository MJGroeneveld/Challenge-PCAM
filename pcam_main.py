...
def train(args):
    ...
    plt.legend()
    plt.show()
    plt.savefig("NetworkDA_10epochs_batchsize512_losses.png")
...
def main_valid(): 
    ...
    plt.legend()
    plt.show()
    plt.savefig("NetworkDA_10epochs_batchsize512_AUC.png")
...
def main_test(): 
    ...
    with open('predictions_network_10epochs.csv', 'w') as file_handler:
        index = 0
