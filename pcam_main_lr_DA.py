...
def train(args):
    ...
    save_model = 'networkDA_model_lr.pt'
    best_val_auc = 0.
    ...
    plt.legend()
    plt.show()
    plt.savefig("NetworkDA_20epochs_batchsize512_losses_lr.png")
...
def main_valid(): 
    args = {'best_model':'networkDA_model_lr.pt',
    ...
    plt.legend()
    plt.show()
    plt.savefig("NetworkDA_20epochs_batchsize512_AUC_lr.png")



#%% 
def main_test(): 
    args = {'best_model':'network_model_lr.pt',
    'dropout': 0.3, #Misschien nog gebruiken
    'batch_size': 512,
    'normalizer_state': None}  #Misschien nog gebruiken
    ...
    with open('predictionsNetwork_DA_LR.csv', 'w') as file_handler:
        index = 0
